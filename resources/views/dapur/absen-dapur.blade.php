...
<body class="bg-light">
  ...
  <script>
    $(function() {
      ...
      function fetchAllAbsenDapur() {
        $.ajax({
          url: '{{ route('fetchAllAbsenDapur') }}',
          method: 'get',
          success: function(response) {
      ...
      function fetchAllAbsenDapurx(from_date = '', to_date = '')
      {
        $.ajax({
        url:"{{ route('fetchAllAbsenDapurx') }}",
        method:"POST",
    ...
    if(from_date != '' &&  to_date != '')
    {
      ...
      fetchAllAbsenDapurx(from_date, to_date);
    }
    else
    {
