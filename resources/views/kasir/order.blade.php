...
@section('content')
<!-- <a href="intent:base64,G0AbYQEbTQBCYWtzbyBTaW1wYW5nClR1Z3UKG00ASmwuIE1heWplbiBILlIuIEVkaSBTdWttYQpDaWF3aSwgS2VjLiBDaWF3aSwgS2FidXBhdGVuIEJvZ29yClRlbHBvbiA6IDA4MTItODQ1Ny00MTIx#Intent;scheme=rawbt;package=ru.a402d.rawbtprinter;end;"> Hello, world! </a> -->
<div class="container">
    ...
    $('.order-minuman').click(function(){
      $.ajax({
        ...
        type: "POST",
        url: "{{route('place-order-minuman')}}",
        data: {id_kasir : {{ Auth::user()->id }}, id_makanan: $(this).attr('data-id')}, // serializes the form's elements.
